package ihm.impl.diagrams.arrows;

import ihm.abstracts.AbstractBasePanel;
import ihm.impl.diagrams.arrows.adapters.Arrow_Adapter;
 ...
 * 
 */
public class Arrow extends AbstractBasePanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9103933502361796294L;
	...
	public Arrow(JPanel src, JPanel dest) {
		...
		this.setAdapter(new Arrow_Adapter());
		MouseActions ma = MouseActions.getInstance();
