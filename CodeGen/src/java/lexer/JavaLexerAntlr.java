// $ANTLR 2.7.7 (20060930): "java15.g.txt" -> "JavaLexer.java"$

package uml.java.lexer;
...
import uml.java.parser.antlr.JavaTokenTypes;
...
public class JavaLexerAntlr extends antlr.CharScanner implements JavaTokenTypes, TokenStream
 {
...
public JavaLexerAntlr(InputStream in) {
	this(new ByteBuffer(in));
}
public JavaLexerAntlr(Reader in) {
	this(new CharBuffer(in));
}
public JavaLexerAntlr(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public JavaLexerAntlr(LexerSharedInputState state) {
	super(state);
